...
app.config['MAIL_USERNAME'] = 'kobayashi.pgworks@gmail.com'
app.config['MAIL_PASSWORD'] = 'sdig qamb bivf oqqr'
app.config['MAIL_USE_TLS'] = True
app.config['MAIL_USE_SSL'] = False
app.config['MAIL_DEFAULT_SENDER'] = 'kobayashi.pgworks@gmail.com'
mail = Mail(app)
